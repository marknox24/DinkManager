...
import { createEvent, listMyEvents } from '../../data/eventsApi';
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {events.map((event, i) => (
            <button
              ...
              className="hover-lift animate-rise-in flex flex-col rounded-2xl border border-ink-100 bg-white p-5 text-left shadow-sm"
            >
