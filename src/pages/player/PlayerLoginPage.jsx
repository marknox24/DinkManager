...
export default function PlayerLoginPage() {
  ...
  const finishLogin = () => {
    ...
    navigate(location.state?.from?.pathname || '/player/dashboard', { replace: true });
  };
      ...
      {step === 'credentials' ? (
        <>
          <div className="mb-6 flex flex-col items-center text-center">
            ...
            <p className="mt-1 text-sm text-ink-500">Sign in to track your registrations</p>
          </div>

          <RoleToggle value="player" mode="login" />
